...
#ifndef __STM32F746G_DISCO_H
#define __STM32F746G_DISCO_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f746g_disco_conf.h"
#include "stm32f746g_disco_errno.h"
#include "main.h"
...
/** @defgroup STM32F746G_DISCO
 * @{
 */

/** @defgroup STM32F746G_DISCO_LOW_LEVEL
 * @{
 */
 ...
 */
#define __STM32F746G_DISCO_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32F746G_DISCO_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32F746G_DISCO_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32F746G_DISCO_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STM32F746G_DISCO_BSP_VERSION        ((__STM32F746G_DISCO_BSP_VERSION_MAIN << 24)\
                                                    |(__STM32F746G_DISCO_BSP_VERSION_SUB1 << 16)\
                                                    |(__STM32F746G_DISCO_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STM32F746G_DISCO_BSP_VERSION_RC))

/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Exported_Types STM32F746G_DISCO LOW LEVEL Exported Types
 * @{
 */

 /**
  * @brief Define for STM32F746G_DISCO board
  */
#if !defined (USE_STM32F746G_DISCO)
 #define USE_STM32F746G_DISCO
#endif
#ifndef USE_BSP_COM_FEATURE
   #define USE_BSP_COM_FEATURE                  0U
#endif

/** @defgroup STM32F746G_DISCO_LOW_LEVEL_LED STM32F746G_DISCO LOW LEVEL LED
 * @{
 */
...
#define BUS_BSP_LED_GPIO_PIN GPIO_PIN_15

/**
 * @}
 */

/** @defgroup STM32F746G_DISCO_LOW_LEVEL_BUTTON STM32F746G_DISCO LOW LEVEL BUTTON
 * @{
 */
/* Button state */
...
#define BUS_GPIO_INSTANCE GPIO
#define BUS_BSP_BUTTON_GPIO_CLK_ENABLE() __HAL_RCC_GPIOI_CLK_ENABLE()
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_11
#define BUS_BSP_BUTTON_GPIO_CLK_DISABLE() __HAL_RCC_GPIOI_CLK_DISABLE()
#define BUS_BSP_BUTTON_GPIO_PORT GPIOI
 ...
 * @}
 */
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_COM STM32F746G_DISCO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Exported_Functions STM32F746G_DISCO LOW LEVEL Exported Functions
 * @{
 */
