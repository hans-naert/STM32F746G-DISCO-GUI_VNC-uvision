...
/** @defgroup STM32F746G_DISCO STM32F746G_DISCO
 * @{
 */

/** @defgroup STM32F746G_DISCO_LOW_LEVEL STM32F746G_DISCO LOW LEVEL
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Private_Defines STM32F746G_DISCO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STM32F746G_DISCO_LOW_LEVEL_FunctionPrototypes STM32F746G_DISCO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Private_Variables STM32F746G_DISCO LOW LEVEL Private Variables
 * @{
 */
...
EXTI_HandleTypeDef hpb_exti[BUTTONn] = {{.Line = EXTI_LINE_11}};
...
/** @defgroup STM32F746G_DISCO_LOW_LEVEL_Private_Functions STM32F746G_DISCO LOW LEVEL Private Functions
 * @{
 */
...
{
  return (int32_t)__STM32F746G_DISCO_BSP_VERSION;
}
