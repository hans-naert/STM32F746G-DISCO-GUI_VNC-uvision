...
void MX_BlueNRG_MS_Init(void)
{
  ...
  if ((bdaddr[5] & 0xC0) != 0xC0) {
    PRINTF("Static Random address not well formed: %02Xn",bdaddr[5]);
    //while(1);
		uint8_t bt_addr[] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0xC6 }; // Static random addr
		aci_hal_write_config_data(0x00, 6, bt_addr);
