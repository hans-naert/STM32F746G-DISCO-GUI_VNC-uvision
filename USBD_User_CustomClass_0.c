...
//uint8_t class0_bulk_out_buf[64] = { 0 };
//uint8_t class0_bulk_in_buf [64] = { 0 };
...
//    memcpy(class0_bulk_in_buf, class0_bulk_out_buf, len);
//    // Transmit back data bytes
//    USBD_EndpointWrite(0, USB_ENDPOINT_IN(1) , class0_bulk_in_buf, len);
